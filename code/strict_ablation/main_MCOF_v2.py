...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default="mcof_attn",
        choices=["mcof_attn", "mcof", "mcof_se", "mcof_no_se", "mcof_no_conv", "mca", "cnn"],
        help="mcof/mcof_se: final SE+Conv model; mcof_no_se: clean minus-channel-attention ablation; mcof_no_conv: clean minus-convolution ablation; mcof_attn/mca/cnn: legacy architectural variants",
    )
