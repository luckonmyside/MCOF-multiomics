...
def main() -> None:
    ...
    feature_names_nested: List[List[str]] = checkpoint.get("feature_names")
    if feature_names_nested is None:
        raise ValueError("Checkpoint does not contain transformed feature names.")
    feature_names = [name for sub in feature_names_nested for name in sub]
